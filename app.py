...
PREDICTED_LABELS = ["rice", "maize", "jowar", "gram"]
PREDICTED_LABELS.sort()


def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/a0ec9e0d-5812-4207-87bd-098219d12d9e'
...
st.title("Agri Crops Image Classifier")#change according to your project
