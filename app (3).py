...
PREDICTED_LABELS = ["rice", "maize", "jowar", "gram"]  # Edit 1
PREDICTED_LABELS.sort()

def get_prediction(image_data):
  #replace your image classification ai service URL
  url = 'https://askai.aiclub.world/a0ec9e0d-5812-4207-87bd-098219d12d9e'  #Edit 2-- get endpoint URL from navigator by deploying your onnx model
...
st.title("Welcome to Crop Image Classifier Web App!")#change according to your project   #edit 3
...
with tab1:
  #setting up the title
  st.header("Crop Image Classifier")#change according to your project   #Edit 3
  #setting up the subheader
  st.subheader("File Uploader")#change according to your project

  #file uploader
  image = st.file_uploader(label="Upload an crop image",accept_multiple_files=False, help="Upload a crop image to classify them")
  if image:
    ...
    response_label = PREDICTED_LABELS[response%4]
...
with tab2:
  ...
  st.link_button("My Github Repository", "https://github.com/cudayab/AIclub") #Edit 4
  ...
  pdf_url = "https://github.com/cudayab/AIclub/blob/main/sample.pdf"
